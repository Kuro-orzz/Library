...
data:
  ...
  bundledCode: "#line 1 \"String/Yosupo/Enumerate_Palindromes.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/enumerate_palindromes\"\n\n#line 2\
    \ \"template.h\"\n\n#include <bits/stdc++.h>\nusing namespace std;\n \n#define\
    ...
    \    d[i]++;\n        }\n        if (i + d[i] > r) {\n            l = j - d[i];\n\
    \            r = i + d[i];\n        }\n    }\n    return d;\n}\n#line 5 \"String/Yosupo/Enumerate_Palindromes.test.cpp\"\
    \n\nvoid solve() {\n    string s; cin >> s;\n    s = '$' + s;\n    vector<int>\
    \ odd = calc_odd(s);\n    vector<int> even = calc_even(s);\n    int n = s.size();\n\
    \    for (int i = 1; i < n; i++) {\n        if (i != n-1) {\n            cout\
    \ << odd[i]*2+1 << ' ' << even[i]*2 << ' ';\n        } else {\n            cout\
  ...
  verifiedWith: []
documentation_of: String/Yosupo/Enumerate_Palindromes.test.cpp
layout: document
redirect_from:
- /verify/String/Yosupo/Enumerate_Palindromes.test.cpp
- /verify/String/Yosupo/Enumerate_Palindromes.test.cpp.html
